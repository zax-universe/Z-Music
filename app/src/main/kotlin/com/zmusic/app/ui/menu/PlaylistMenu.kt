...
import com.zmusic.app.ui.menu.ExportDialog
import com.zmusic.app.utils.PlaylistExporter
    ...
    if (showExportDialog) {
        ExportDialog(
            ...
            onShare = { format ->
                val playlistSongs =
                    songs.map { s ->
                        com.zmusic.app.db.entities.PlaylistSong(
                            map =
                                com.zmusic.app.db.entities.PlaylistSongMap(
                                    songId = s.id,
