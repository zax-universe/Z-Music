...
package com.zmusic.app.utils

import android.net.ConnectivityManager
import android.net.Uri
import android.util.Log
import androidx.media3.common.PlaybackException
import com.zmusic.innertube.NewPipeExtractor
import com.zmusic.innertube.YouTube
import com.zmusic.innertube.models.YouTubeClient
import com.zmusic.innertube.models.YouTubeClient.Companion.ANDROID_CREATOR
import com.zmusic.innertube.models.YouTubeClient.Companion.ANDROID_VR_1_43_32
import com.zmusic.innertube.models.YouTubeClient.Companion.ANDROID_VR_1_61_48
import com.zmusic.innertube.models.YouTubeClient.Companion.ANDROID_VR_NO_AUTH
import com.zmusic.innertube.models.YouTubeClient.Companion.IOS
import com.zmusic.innertube.models.YouTubeClient.Companion.IPADOS
import com.zmusic.innertube.models.YouTubeClient.Companion.MOBILE
import com.zmusic.innertube.models.YouTubeClient.Companion.TVHTML5
import com.zmusic.innertube.models.YouTubeClient.Companion.TVHTML5_SIMPLY_EMBEDDED_PLAYER
import com.zmusic.innertube.models.YouTubeClient.Companion.WEB
import com.zmusic.innertube.models.YouTubeClient.Companion.WEB_CREATOR
...
import com.zmusic.app.utils.cipher.CipherDeobfuscator
import com.zmusic.app.utils.YTPlayerUtils.MAIN_CLIENT
import com.zmusic.app.utils.YTPlayerUtils.STREAM_FALLBACK_CLIENTS
import com.zmusic.app.utils.YTPlayerUtils.validateStatus
import com.zmusic.app.utils.potoken.PoTokenGenerator
import com.zmusic.app.utils.potoken.PoTokenResult
import com.zmusic.app.utils.sabr.EjsNTransformSolver
...
object YTPlayerUtils {
    ...
    suspend fun playerResponseForPlayback(
                    ...
                    try {
                        ...
                        if (originalUrl == streamUrl && skipNewPipe) {
                            ...
                            try {
                                ...
                                com.zmusic.innertube.NewPipeUtils
                                val newPipeUrl = com.zmusic.innertube.NewPipeExtractor.getThrottlingDeobfuscatedUrl(videoId, streamUrl)
        ...
        if (streamPlayerResponse.playabilityStatus.status != "OK") {
            ...
            // unavailable streams; Z-Music cannot recover those without official playback.
    ...
    private fun getSignatureTimestampOrNull(videoId: String): SignatureTimestampResult {
        ...
        com.zmusic.innertube.NewPipeUtils  // Ensure NewPipe downloader is initialized before use
