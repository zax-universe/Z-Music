...
package com.zmusic.app.listentogether
...
import com.zmusic.app.constants.ListenTogetherIsHostKey
import com.zmusic.app.constants.ListenTogetherRoomCodeKey
import com.zmusic.app.constants.ListenTogetherServerUrlKey
import com.zmusic.app.constants.ListenTogetherSessionTimestampKey
import com.zmusic.app.constants.ListenTogetherSessionTokenKey
import com.zmusic.app.constants.ListenTogetherUserIdKey
...
class ListenTogetherClient
    ...
    constructor(
        ...
        companion object {
            ...
            const val ACTION_APPROVE_JOIN = "com.zmusic.app.LISTEN_TOGETHER_APPROVE_JOIN"
            const val ACTION_REJECT_JOIN = "com.zmusic.app.LISTEN_TOGETHER_REJECT_JOIN"
            const val ACTION_APPROVE_SUGGESTION = "com.zmusic.app.LISTEN_TOGETHER_APPROVE_SUGGESTION"
            const val ACTION_REJECT_SUGGESTION = "com.zmusic.app.LISTEN_TOGETHER_REJECT_SUGGESTION"
        ...
        private fun loadBlockedUsernames() {
            try {
                val blockedJson = context.dataStore.get(com.zmusic.app.constants.ListenTogetherBlockedUsersKey, "")
                val blockedList =
        ...
        private suspend fun saveBlockedUsernames() {
            try {
                ...
                context.dataStore.edit { preferences ->
                    preferences[com.zmusic.app.constants.ListenTogetherBlockedUsersKey] = blockedJson
                }
            } catch (e: Exception) {
