...
# Since Z-Music is fully open-source, obfuscation provides no meaningful security benefit.
-dontobfuscate

# WEB_REMIX Streaming - WebView JavaScript interfaces
-keepclassmembers class com.zmusic.app.utils.sabr.EjsNTransformSolver$SolverWebView {
    @android.webkit.JavascriptInterface public *;
}
-keepclassmembers class com.zmusic.app.utils.cipher.CipherWebView {
    @android.webkit.JavascriptInterface public *;
}
-keepclassmembers class com.zmusic.app.utils.potoken.PoTokenWebView {
    @android.webkit.JavascriptInterface public *;
}

# Keep streaming utility classes
-keep class com.zmusic.app.utils.cipher.** { *; }
-keep class com.zmusic.app.utils.sabr.** { *; }
-keep class com.zmusic.app.utils.potoken.** { *; }
...
-keep class com.zmusic.app.models.PersistQueue { *; }
-keep class com.zmusic.app.models.PersistPlayerState { *; }
-keep class com.zmusic.app.models.QueueData { *; }
-keep class com.zmusic.app.models.QueueType { *; }
-keep class com.zmusic.app.playback.queues.** { *; }
...
## Google Cast Rules
-keep class com.zmusic.app.cast.** { *; }
...
-keep class com.zmusic.app.recognition.VibraSignature { *; }
-keepclassmembers class com.zmusic.app.recognition.VibraSignature {
    native <methods>;
}
...
-keep class com.zmusic.app.listentogether.proto.** { *; }
-keepclassmembers class com.zmusic.app.listentogether.proto.** { *; }

## Shazam Models
-keep class com.zmusic.shazamkit.models.** { *; }
-keepclassmembers class com.zmusic.shazamkit.models.** {
    *;
}
...
-keepclasseswithmembers class com.zmusic.shazamkit.models.** {
    kotlinx.serialization.KSerializer serializer(...);
}
